...
MySQL - 5.6.21 : Database - shonamanik
*********************************************************************
*/
...
/*Data for the table `sm_address` */

/*Table structure for table `sm_affiliate` */

DROP TABLE IF EXISTS `sm_affiliate`;
...
/*Data for the table `sm_affiliate` */

/*Table structure for table `sm_affiliate_activity` */

DROP TABLE IF EXISTS `sm_affiliate_activity`;
...
/*Data for the table `sm_affiliate_activity` */

/*Table structure for table `sm_affiliate_login` */

DROP TABLE IF EXISTS `sm_affiliate_login`;
...
/*Data for the table `sm_affiliate_login` */

/*Table structure for table `sm_affiliate_transaction` */

DROP TABLE IF EXISTS `sm_affiliate_transaction`;
...
/*Data for the table `sm_affiliate_transaction` */
...
/*Data for the table `sm_api` */

insert  into `sm_api`(`api_id`,`name`,`key`,`status`,`date_added`,`date_modified`) values (1,'Default','',1,'2017-02-27 21:59:44','2017-02-27 21:59:44');

/*Table structure for table `sm_api_ip` */

DROP TABLE IF EXISTS `sm_api_ip`;

CREATE TABLE `sm_api_ip` (
...
/*Data for the table `sm_api_ip` */

/*Table structure for table `sm_api_session` */

DROP TABLE IF EXISTS `sm_api_session`;

CREATE TABLE `sm_api_session` (
...
/*Data for the table `sm_api_session` */
...
/*Data for the table `sm_attribute` */

insert  into `sm_attribute`(`attribute_id`,`attribute_group_id`,`sort_order`) values (1,6,1),(2,6,5),(3,6,3),(4,3,1),(5,3,2),(6,3,3),(7,3,4),(8,3,5),(9,3,6),(10,3,7),(11,3,8);

/*Table structure for table `sm_attribute_description` */

DROP TABLE IF EXISTS `sm_attribute_description`;
...
/*Data for the table `sm_attribute_description` */

insert  into `sm_attribute_description`(`attribute_id`,`language_id`,`name`) values (1,1,'Description'),(2,1,'No. of Cores'),(4,1,'test 1'),(5,1,'test 2'),(6,1,'test 3'),(7,1,'test 4'),(8,1,'test 5'),(9,1,'test 6'),(10,1,'test 7'),(11,1,'test 8'),(3,1,'Clockspeed');

/*Table structure for table `sm_attribute_group` */

DROP TABLE IF EXISTS `sm_attribute_group`;
...
/*Data for the table `sm_attribute_group` */

insert  into `sm_attribute_group`(`attribute_group_id`,`sort_order`) values (3,2),(4,1),(5,3),(6,4);

/*Table structure for table `sm_attribute_group_description` */

DROP TABLE IF EXISTS `sm_attribute_group_description`;
...
/*Data for the table `sm_attribute_group_description` */

insert  into `sm_attribute_group_description`(`attribute_group_id`,`language_id`,`name`) values (3,1,'Memory'),(4,1,'Technical'),(5,1,'Motherboard'),(6,1,'Processor');
...
insert  into `sm_banner`(`banner_id`,`name`,`status`) values (6,'HP Products',1),(7,'Home Page Slideshow',1),(8,'Manufacturers',1);

/*Table structure for table `sm_banner_image` */

DROP TABLE IF EXISTS `sm_banner_image`;
...
/*Data for the table `sm_banner_image` */

insert  into `sm_banner_image`(`banner_image_id`,`banner_id`,`language_id`,`title`,`link`,`image`,`sort_order`) values (79,7,1,'iPhone 6','index.php?route=product/product&amp;path=57&amp;product_id=49','catalog/demo/banners/iPhone6.jpg',0),(87,6,1,'HP Banner','index.php?route=product/manufacturer/info&amp;manufacturer_id=7','catalog/demo/compaq_presario.jpg',0),(94,8,1,'NFL','','catalog/demo/manufacturer/nfl.png',0),(95,8,1,'RedBull','','catalog/demo/manufacturer/redbull.png',0),(96,8,1,'Sony','','catalog/demo/manufacturer/sony.png',0),(91,8,1,'Coca Cola','','catalog/demo/manufacturer/cocacola.png',0),(92,8,1,'Burger King','','catalog/demo/manufacturer/burgerking.png',0),(93,8,1,'Canon','','catalog/demo/manufacturer/canon.png',0),(88,8,1,'Harley Davidson','','catalog/demo/manufacturer/harley.png',0),(89,8,1,'Dell','','catalog/demo/manufacturer/dell.png',0),(90,8,1,'Disney','','catalog/demo/manufacturer/disney.png',0),(80,7,1,'MacBookAir','','catalog/demo/banners/MacBookAir.jpg',0),(97,8,1,'Starbucks','','catalog/demo/manufacturer/starbucks.png',0),(98,8,1,'Nintendo','','catalog/demo/manufacturer/nintendo.png',0);
...
/*Data for the table `sm_category_filter` */

/*Table structure for table `sm_category_path` */

DROP TABLE IF EXISTS `sm_category_path`;
...
/*Data for the table `sm_category_to_layout` */

/*Table structure for table `sm_category_to_store` */

DROP TABLE IF EXISTS `sm_category_to_store`;
...
/*Data for the table `sm_category_to_store` */

insert  into `sm_category_to_store`(`category_id`,`store_id`) values (17,0),(18,0),(20,0),(24,0),(25,0),(26,0),(27,0),(28,0),(29,0),(30,0),(31,0),(32,0),(33,0),(34,0),(35,0),(36,0),(37,0),(38,0),(39,0),(40,0),(41,0),(42,0),(43,0),(44,0),(45,0),(46,0),(47,0),(48,0),(49,0),(50,0),(51,0),(52,0),(53,0),(54,0),(55,0),(56,0),(57,0),(58,0);

/*Table structure for table `sm_country` */

DROP TABLE IF EXISTS `sm_country`;
...
/*Data for the table `sm_coupon_category` */

/*Table structure for table `sm_coupon_history` */

DROP TABLE IF EXISTS `sm_coupon_history`;
...
/*Data for the table `sm_coupon_history` */

/*Table structure for table `sm_coupon_product` */

DROP TABLE IF EXISTS `sm_coupon_product`;
...
/*Data for the table `sm_coupon_product` */

/*Table structure for table `sm_currency` */

DROP TABLE IF EXISTS `sm_currency`;
...
/*Data for the table `sm_currency` */

insert  into `sm_currency`(`currency_id`,`title`,`code`,`symbol_left`,`symbol_right`,`decimal_place`,`value`,`status`,`date_modified`) values (1,'Pound Sterling','GBP','£','','2',0.80190003,1,'2017-02-27 17:00:08'),(2,'US Dollar','USD','$','','2',1.00000000,1,'2017-02-27 17:02:28'),(3,'Euro','EUR','','€','2',0.94190001,1,'2017-02-27 17:00:08');

/*Table structure for table `sm_custom_field` */

DROP TABLE IF EXISTS `sm_custom_field`;
...
/*Data for the table `sm_custom_field` */

/*Table structure for table `sm_custom_field_customer_group` */

DROP TABLE IF EXISTS `sm_custom_field_customer_group`;
...
/*Data for the table `sm_custom_field_customer_group` */

/*Table structure for table `sm_custom_field_description` */

DROP TABLE IF EXISTS `sm_custom_field_description`;
...
/*Data for the table `sm_custom_field_description` */

/*Table structure for table `sm_custom_field_value` */

DROP TABLE IF EXISTS `sm_custom_field_value`;
...
/*Data for the table `sm_custom_field_value` */

/*Table structure for table `sm_custom_field_value_description` */

DROP TABLE IF EXISTS `sm_custom_field_value_description`;
...
/*Data for the table `sm_custom_field_value_description` */
...
/*Data for the table `sm_customer` */

/*Table structure for table `sm_customer_activity` */

DROP TABLE IF EXISTS `sm_customer_activity`;
...
/*Data for the table `sm_customer_activity` */

/*Table structure for table `sm_customer_group` */

DROP TABLE IF EXISTS `sm_customer_group`;
...
/*Data for the table `sm_customer_group` */

insert  into `sm_customer_group`(`customer_group_id`,`approval`,`sort_order`) values (1,0,1);

/*Table structure for table `sm_customer_group_description` */

DROP TABLE IF EXISTS `sm_customer_group_description`;
...
/*Data for the table `sm_customer_group_description` */

insert  into `sm_customer_group_description`(`customer_group_id`,`language_id`,`name`,`description`) values (1,1,'Default','test');

/*Table structure for table `sm_customer_history` */

DROP TABLE IF EXISTS `sm_customer_history`;
...
/*Data for the table `sm_customer_history` */

/*Table structure for table `sm_customer_ip` */

DROP TABLE IF EXISTS `sm_customer_ip`;
...
/*Data for the table `sm_customer_ip` */

/*Table structure for table `sm_customer_login` */

DROP TABLE IF EXISTS `sm_customer_login`;
...
/*Data for the table `sm_customer_login` */

/*Table structure for table `sm_customer_online` */

DROP TABLE IF EXISTS `sm_customer_online`;
...
/*Data for the table `sm_customer_online` */

/*Table structure for table `sm_customer_reward` */

DROP TABLE IF EXISTS `sm_customer_reward`;
...
/*Data for the table `sm_customer_reward` */

/*Table structure for table `sm_customer_search` */

DROP TABLE IF EXISTS `sm_customer_search`;

CREATE TABLE `sm_customer_search` (
...
/*Data for the table `sm_customer_search` */

/*Table structure for table `sm_customer_transaction` */

DROP TABLE IF EXISTS `sm_customer_transaction`;
...
/*Data for the table `sm_customer_transaction` */

/*Table structure for table `sm_customer_wishlist` */

DROP TABLE IF EXISTS `sm_customer_wishlist`;

CREATE TABLE `sm_customer_wishlist` (
  `customer_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `date_added` datetime NOT NULL,
...
/*Data for the table `sm_customer_wishlist` */

/*Table structure for table `sm_download` */

DROP TABLE IF EXISTS `sm_download`;
...
/*Data for the table `sm_download` */

/*Table structure for table `sm_download_description` */

DROP TABLE IF EXISTS `sm_download_description`;
...
/*Data for the table `sm_download_description` */
...
/*Data for the table `sm_event` */

insert  into `sm_event`(`event_id`,`code`,`trigger`,`action`,`status`,`date_added`) values (1,'voucher','catalog/model/checkout/order/addOrderHistory/after','extension/total/voucher/send',0,'0000-00-00 00:00:00');

/*Table structure for table `sm_extension` */

DROP TABLE IF EXISTS `sm_extension`;
...
/*Data for the table `sm_filter` */

/*Table structure for table `sm_filter_description` */

DROP TABLE IF EXISTS `sm_filter_description`;
...
/*Data for the table `sm_filter_description` */

/*Table structure for table `sm_filter_group` */

DROP TABLE IF EXISTS `sm_filter_group`;
...
/*Data for the table `sm_filter_group` */

/*Table structure for table `sm_filter_group_description` */

DROP TABLE IF EXISTS `sm_filter_group_description`;
...
/*Data for the table `sm_filter_group_description` */

/*Table structure for table `sm_geo_zone` */

DROP TABLE IF EXISTS `sm_geo_zone`;
...
/*Data for the table `sm_geo_zone` */

insert  into `sm_geo_zone`(`geo_zone_id`,`name`,`description`,`date_modified`,`date_added`) values (3,'UK VAT Zone','UK VAT','2010-02-26 22:33:24','2009-01-06 23:26:25'),(4,'UK Shipping','UK Shipping Zones','2010-12-15 15:18:13','2009-06-23 01:14:53');

/*Table structure for table `sm_information` */

DROP TABLE IF EXISTS `sm_information`;
...
/*Data for the table `sm_information` */

insert  into `sm_information`(`information_id`,`bottom`,`sort_order`,`status`) values (3,1,3,1),(4,1,1,1),(5,1,4,1),(6,1,2,1);

/*Table structure for table `sm_information_description` */

DROP TABLE IF EXISTS `sm_information_description`;
...
/*Data for the table `sm_information_description` */

insert  into `sm_information_description`(`information_id`,`language_id`,`title`,`description`,`meta_title`,`meta_description`,`meta_keyword`) values (4,1,'About Us','&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n','About Us','',''),(5,1,'Terms &amp; Conditions','&lt;p&gt;\r\n	Terms &amp;amp; Conditions&lt;/p&gt;\r\n','Terms &amp; Conditions','',''),(3,1,'Privacy Policy','&lt;p&gt;\r\n	Privacy Policy&lt;/p&gt;\r\n','Privacy Policy','',''),(6,1,'Delivery Information','&lt;p&gt;\r\n	Delivery Information&lt;/p&gt;\r\n','Delivery Information','','');

/*Table structure for table `sm_information_to_layout` */

DROP TABLE IF EXISTS `sm_information_to_layout`;
...
/*Data for the table `sm_information_to_layout` */

/*Table structure for table `sm_information_to_store` */

DROP TABLE IF EXISTS `sm_information_to_store`;
...
/*Data for the table `sm_information_to_store` */

insert  into `sm_information_to_store`(`information_id`,`store_id`) values (3,0),(4,0),(5,0),(6,0);
...
/*Data for the table `sm_language` */

insert  into `sm_language`(`language_id`,`name`,`code`,`locale`,`image`,`directory`,`sort_order`,`status`) values (1,'English','en-gb','en-US,en_US.UTF-8,en_US,en-gb,english','gb.png','english',1,1);

/*Table structure for table `sm_layout` */

DROP TABLE IF EXISTS `sm_layout`;
...
/*Data for the table `sm_layout` */

insert  into `sm_layout`(`layout_id`,`name`) values (1,'Home'),(2,'Product'),(3,'Category'),(4,'Default'),(5,'Manufacturer'),(6,'Account'),(7,'Checkout'),(8,'Contact'),(9,'Sitemap'),(10,'Affiliate'),(11,'Information'),(12,'Compare'),(13,'Search');

/*Table structure for table `sm_layout_module` */

DROP TABLE IF EXISTS `sm_layout_module`;
...
/*Data for the table `sm_layout_module` */

insert  into `sm_layout_module`(`layout_module_id`,`layout_id`,`code`,`position`,`sort_order`) values (2,4,'0','content_top',0),(3,4,'0','content_top',1),(20,5,'0','column_left',2),(69,10,'affiliate','column_right',1),(68,6,'account','column_right',1),(67,1,'carousel.29','content_top',3),(66,1,'slideshow.27','content_top',1),(65,1,'featured.28','content_top',2),(72,3,'category','column_left',1),(73,3,'banner.30','column_left',2);

/*Table structure for table `sm_layout_route` */

DROP TABLE IF EXISTS `sm_layout_route`;
...
/*Data for the table `sm_layout_route` */

insert  into `sm_layout_route`(`layout_route_id`,`layout_id`,`store_id`,`route`) values (38,6,0,'account/%'),(17,10,0,'affiliate/%'),(44,3,0,'product/category'),(42,1,0,'common/home'),(20,2,0,'product/product'),(24,11,0,'information/information'),(23,7,0,'checkout/%'),(31,8,0,'information/contact'),(32,9,0,'information/sitemap'),(34,4,0,''),(45,5,0,'product/manufacturer'),(52,12,0,'product/compare'),(53,13,0,'product/search');

/*Table structure for table `sm_length_class` */

DROP TABLE IF EXISTS `sm_length_class`;
...
/*Data for the table `sm_length_class` */

insert  into `sm_length_class`(`length_class_id`,`value`) values (1,1.00000000),(2,10.00000000),(3,0.39370000);

/*Table structure for table `sm_length_class_description` */

DROP TABLE IF EXISTS `sm_length_class_description`;
...
/*Data for the table `sm_length_class_description` */

insert  into `sm_length_class_description`(`length_class_id`,`language_id`,`title`,`unit`) values (1,1,'Centimeter','cm'),(2,1,'Millimeter','mm'),(3,1,'Inch','in');

/*Table structure for table `sm_location` */

DROP TABLE IF EXISTS `sm_location`;
...
/*Data for the table `sm_location` */

/*Table structure for table `sm_manufacturer` */

DROP TABLE IF EXISTS `sm_manufacturer`;
...
/*Data for the table `sm_manufacturer` */

insert  into `sm_manufacturer`(`manufacturer_id`,`name`,`image`,`sort_order`) values (5,'HTC','catalog/demo/htc_logo.jpg',0),(6,'Palm','catalog/demo/palm_logo.jpg',0),(7,'Hewlett-Packard','catalog/demo/hp_logo.jpg',0),(8,'Apple','catalog/demo/apple_logo.jpg',0),(9,'Canon','catalog/demo/canon_logo.jpg',0),(10,'Sony','catalog/demo/sony_logo.jpg',0);

/*Table structure for table `sm_manufacturer_to_store` */

DROP TABLE IF EXISTS `sm_manufacturer_to_store`;
...
/*Data for the table `sm_manufacturer_to_store` */

insert  into `sm_manufacturer_to_store`(`manufacturer_id`,`store_id`) values (5,0),(6,0),(7,0),(8,0),(9,0),(10,0);

/*Table structure for table `sm_marketing` */

DROP TABLE IF EXISTS `sm_marketing`;
...
/*Data for the table `sm_marketing` */
...
/*Table structure for table `sm_menu_description` */

DROP TABLE IF EXISTS `sm_menu_description`;

CREATE TABLE `sm_menu_description` (
...
/*Data for the table `sm_menu_description` */

/*Table structure for table `sm_menu_module` */

DROP TABLE IF EXISTS `sm_menu_module`;

CREATE TABLE `sm_menu_module` (
...
/*Data for the table `sm_menu_module` */

/*Table structure for table `sm_modification` */

DROP TABLE IF EXISTS `sm_modification`;
...
/*Data for the table `sm_modification` */
...
/*Data for the table `sm_option` */

insert  into `sm_option`(`option_id`,`type`,`sort_order`) values (1,'radio',1),(2,'checkbox',2),(4,'text',3),(5,'select',4),(6,'textarea',5),(7,'file',6),(8,'date',7),(9,'time',8),(10,'datetime',9),(11,'select',10),(12,'date',11);

/*Table structure for table `sm_option_description` */

DROP TABLE IF EXISTS `sm_option_description`;
...
/*Data for the table `sm_option_description` */

insert  into `sm_option_description`(`option_id`,`language_id`,`name`) values (1,1,'Radio'),(2,1,'Checkbox'),(4,1,'Text'),(6,1,'Textarea'),(8,1,'Date'),(7,1,'File'),(5,1,'Select'),(9,1,'Time'),(10,1,'Date &amp; Time'),(12,1,'Delivery Date'),(11,1,'Size');

/*Table structure for table `sm_option_value` */

DROP TABLE IF EXISTS `sm_option_value`;
...
/*Data for the table `sm_option_value` */

insert  into `sm_option_value`(`option_value_id`,`option_id`,`image`,`sort_order`) values (43,1,'',3),(32,1,'',1),(45,2,'',4),(44,2,'',3),(42,5,'',4),(41,5,'',3),(39,5,'',1),(40,5,'',2),(31,1,'',2),(23,2,'',1),(24,2,'',2),(46,11,'',1),(47,11,'',2),(48,11,'',3);

/*Table structure for table `sm_option_value_description` */

DROP TABLE IF EXISTS `sm_option_value_description`;
...
/*Data for the table `sm_option_value_description` */

insert  into `sm_option_value_description`(`option_value_id`,`language_id`,`option_id`,`name`) values (43,1,1,'Large'),(32,1,1,'Small'),(45,1,2,'Checkbox 4'),(44,1,2,'Checkbox 3'),(31,1,1,'Medium'),(42,1,5,'Yellow'),(41,1,5,'Green'),(39,1,5,'Red'),(40,1,5,'Blue'),(23,1,2,'Checkbox 1'),(24,1,2,'Checkbox 2'),(48,1,11,'Large'),(47,1,11,'Medium'),(46,1,11,'Small');
...
DROP TABLE IF EXISTS `sm_order_custom_field`;
...
/*Data for the table `sm_order_custom_field` */

/*Table structure for table `sm_order_history` */

DROP TABLE IF EXISTS `sm_order_history`;
...
/*Data for the table `sm_order_history` */

/*Table structure for table `sm_order_option` */

DROP TABLE IF EXISTS `sm_order_option`;
...
/*Data for the table `sm_order_option` */

/*Table structure for table `sm_order_product` */

DROP TABLE IF EXISTS `sm_order_product`;
...
/*Data for the table `sm_order_product` */

/*Table structure for table `sm_order_recurring` */

DROP TABLE IF EXISTS `sm_order_recurring`;
...
/*Data for the table `sm_order_recurring` */

/*Table structure for table `sm_order_recurring_transaction` */

DROP TABLE IF EXISTS `sm_order_recurring_transaction`;
...
/*Data for the table `sm_order_recurring_transaction` */

/*Table structure for table `sm_order_status` */

DROP TABLE IF EXISTS `sm_order_status`;
...
/*Data for the table `sm_order_status` */

insert  into `sm_order_status`(`order_status_id`,`language_id`,`name`) values (2,1,'Processing'),(3,1,'Shipped'),(7,1,'Canceled'),(5,1,'Complete'),(8,1,'Denied'),(9,1,'Canceled Reversal'),(10,1,'Failed'),(11,1,'Refunded'),(12,1,'Reversed'),(13,1,'Chargeback'),(1,1,'Pending'),(16,1,'Voided'),(15,1,'Processed'),(14,1,'Expired');

/*Table structure for table `sm_order_total` */

DROP TABLE IF EXISTS `sm_order_total`;
...
/*Data for the table `sm_order_total` */

/*Table structure for table `sm_order_voucher` */

DROP TABLE IF EXISTS `sm_order_voucher`;
...
/*Data for the table `sm_order_voucher` */
...
DROP TABLE IF EXISTS `sm_product_attribute`;
...
/*Data for the table `sm_product_attribute` */

insert  into `sm_product_attribute`(`product_id`,`attribute_id`,`language_id`,`text`) values (43,2,1,'1'),(47,4,1,'16GB'),(43,4,1,'8gb'),(42,3,1,'100mhz'),(47,2,1,'4');

/*Table structure for table `sm_product_description` */

DROP TABLE IF EXISTS `sm_product_description`;
...
/*Data for the table `sm_product_discount` */

insert  into `sm_product_discount`(`product_discount_id`,`product_id`,`customer_group_id`,`quantity`,`priority`,`price`,`date_start`,`date_end`) values (440,42,1,30,1,66.0000,'0000-00-00','0000-00-00'),(439,42,1,20,1,77.0000,'0000-00-00','0000-00-00'),(438,42,1,10,1,88.0000,'0000-00-00','0000-00-00');

/*Table structure for table `sm_product_filter` */

DROP TABLE IF EXISTS `sm_product_filter`;
...
/*Data for the table `sm_product_filter` */
...
/*Data for the table `sm_product_option` */

insert  into `sm_product_option`(`product_option_id`,`product_id`,`option_id`,`value`,`required`) values (224,35,11,'',1),(225,47,12,'2011-04-22',1),(223,42,2,'',1),(217,42,5,'',1),(209,42,6,'',1),(218,42,1,'',1),(208,42,4,'test',1),(219,42,8,'2011-02-20',1),(222,42,7,'',1),(221,42,9,'22:25',1),(220,42,10,'2011-02-20 22:25',1),(226,30,5,'',1);

/*Table structure for table `sm_product_option_value` */

DROP TABLE IF EXISTS `sm_product_option_value`;
...
/*Data for the table `sm_product_recurring` */
...
/*Data for the table `sm_product_related` */

insert  into `sm_product_related`(`product_id`,`related_id`) values (40,42),(41,42),(42,40),(42,41);

/*Table structure for table `sm_product_reward` */

DROP TABLE IF EXISTS `sm_product_reward`;
...
/*Data for the table `sm_product_reward` */

insert  into `sm_product_reward`(`product_reward_id`,`product_id`,`customer_group_id`,`points`) values (515,42,1,100),(519,47,1,300),(379,28,1,400),(329,43,1,600),(339,29,1,0),(343,48,1,0),(335,40,1,0),(539,30,1,200),(331,44,1,700),(333,45,1,800),(337,31,1,0),(425,35,1,0),(345,33,1,0),(347,46,1,0),(545,41,1,0),(351,36,1,0),(353,34,1,0),(355,32,1,0),(521,49,1,1000);

/*Table structure for table `sm_product_special` */

DROP TABLE IF EXISTS `sm_product_special`;
...
/*Data for the table `sm_product_special` */

insert  into `sm_product_special`(`product_special_id`,`product_id`,`customer_group_id`,`priority`,`price`,`date_start`,`date_end`) values (419,42,1,1,90.0000,'0000-00-00','0000-00-00'),(439,30,1,2,90.0000,'0000-00-00','0000-00-00'),(438,30,1,1,80.0000,'0000-00-00','0000-00-00');

/*Table structure for table `sm_product_to_category` */

DROP TABLE IF EXISTS `sm_product_to_category`;
...
/*Data for the table `sm_product_to_category` */

insert  into `sm_product_to_category`(`product_id`,`category_id`) values (28,20),(28,24),(29,20),(29,24),(30,20),(30,33),(31,33),(32,34),(33,20),(33,28),(34,34),(35,20),(36,34),(40,20),(40,24),(41,27),(42,20),(42,28),(43,18),(43,20),(44,18),(44,20),(45,18),(46,18),(46,20),(47,18),(47,20),(48,20),(48,34),(49,57);

/*Table structure for table `sm_product_to_download` */

DROP TABLE IF EXISTS `sm_product_to_download`;
...
/*Data for the table `sm_product_to_download` */

/*Table structure for table `sm_product_to_layout` */

DROP TABLE IF EXISTS `sm_product_to_layout`;
...
/*Data for the table `sm_product_to_layout` */

/*Table structure for table `sm_product_to_store` */

DROP TABLE IF EXISTS `sm_product_to_store`;
...
/*Data for the table `sm_product_to_store` */

insert  into `sm_product_to_store`(`product_id`,`store_id`) values (28,0),(29,0),(30,0),(31,0),(32,0),(33,0),(34,0),(35,0),(36,0),(40,0),(41,0),(42,0),(43,0),(44,0),(45,0),(46,0),(47,0),(48,0),(49,0);

/*Table structure for table `sm_recurring` */

DROP TABLE IF EXISTS `sm_recurring`;
...
/*Data for the table `sm_recurring` */

/*Table structure for table `sm_recurring_description` */

DROP TABLE IF EXISTS `sm_recurring_description`;
...
/*Data for the table `sm_recurring_description` */

/*Table structure for table `sm_return` */

DROP TABLE IF EXISTS `sm_return`;
...
/*Data for the table `sm_return` */

/*Table structure for table `sm_return_action` */

DROP TABLE IF EXISTS `sm_return_action`;
...
/*Data for the table `sm_return_action` */

insert  into `sm_return_action`(`return_action_id`,`language_id`,`name`) values (1,1,'Refunded'),(2,1,'Credit Issued'),(3,1,'Replacement Sent');

/*Table structure for table `sm_return_history` */

DROP TABLE IF EXISTS `sm_return_history`;
...
/*Data for the table `sm_return_history` */

/*Table structure for table `sm_return_reason` */

DROP TABLE IF EXISTS `sm_return_reason`;
...
/*Data for the table `sm_return_reason` */

insert  into `sm_return_reason`(`return_reason_id`,`language_id`,`name`) values (1,1,'Dead On Arrival'),(2,1,'Received Wrong Item'),(3,1,'Order Error'),(4,1,'Faulty, please supply details'),(5,1,'Other, please supply details');

/*Table structure for table `sm_return_status` */

DROP TABLE IF EXISTS `sm_return_status`;
...
/*Data for the table `sm_return_status` */

insert  into `sm_return_status`(`return_status_id`,`language_id`,`name`) values (1,1,'Pending'),(3,1,'Complete'),(2,1,'Awaiting Products');

/*Table structure for table `sm_review` */

DROP TABLE IF EXISTS `sm_review`;
...
/*Data for the table `sm_stock_status` */

insert  into `sm_stock_status`(`stock_status_id`,`language_id`,`name`) values (7,1,'In Stock'),(8,1,'Pre-Order'),(5,1,'Out Of Stock'),(6,1,'2-3 Days');

/*Table structure for table `sm_store` */

DROP TABLE IF EXISTS `sm_store`;
...
/*Data for the table `sm_store` */

/*Table structure for table `sm_tax_class` */

DROP TABLE IF EXISTS `sm_tax_class`;
...
/*Data for the table `sm_tax_class` */

insert  into `sm_tax_class`(`tax_class_id`,`title`,`description`,`date_added`,`date_modified`) values (9,'Taxable Goods','Taxed goods','2009-01-06 23:21:53','2011-09-23 14:07:50'),(10,'Downloadable Products','Downloadable','2011-09-21 22:19:39','2011-09-22 10:27:36');

/*Table structure for table `sm_tax_rate` */

DROP TABLE IF EXISTS `sm_tax_rate`;
...
/*Data for the table `sm_tax_rate` */

insert  into `sm_tax_rate`(`tax_rate_id`,`geo_zone_id`,`name`,`rate`,`type`,`date_added`,`date_modified`) values (86,3,'VAT (20%)',20.0000,'P','2011-03-09 21:17:10','2011-09-22 22:24:29'),(87,3,'Eco Tax (-2.00)',2.0000,'F','2011-09-21 21:49:23','2011-09-23 00:40:19');

/*Table structure for table `sm_tax_rate_to_customer_group` */

DROP TABLE IF EXISTS `sm_tax_rate_to_customer_group`;
...
/*Data for the table `sm_tax_rate_to_customer_group` */

insert  into `sm_tax_rate_to_customer_group`(`tax_rate_id`,`customer_group_id`) values (86,1),(87,1);

/*Table structure for table `sm_tax_rule` */

DROP TABLE IF EXISTS `sm_tax_rule`;
...
/*Data for the table `sm_tax_rule` */

insert  into `sm_tax_rule`(`tax_rule_id`,`tax_class_id`,`tax_rate_id`,`based`,`priority`) values (121,10,86,'payment',1),(120,10,87,'store',0),(128,9,86,'shipping',1),(127,9,87,'shipping',2);

/*Table structure for table `sm_theme` */

DROP TABLE IF EXISTS `sm_theme`;

CREATE TABLE `sm_theme` (
...
/*Data for the table `sm_theme` */

/*Table structure for table `sm_translation` */

DROP TABLE IF EXISTS `sm_translation`;

CREATE TABLE `sm_translation` (
...
/*Data for the table `sm_translation` */

/*Table structure for table `sm_upload` */

DROP TABLE IF EXISTS `sm_upload`;
...
/*Data for the table `sm_upload` */

/*Table structure for table `sm_url_alias` */

DROP TABLE IF EXISTS `sm_url_alias`;
...
insert  into `sm_user`(`user_id`,`user_group_id`,`username`,`password`,`salt`,`firstname`,`lastname`,`email`,`image`,`code`,`ip`,`status`,`date_added`) values (1,1,'admin','c8740a9ccf95ca7b5f800d4923c60ef158bd92e3','edUJTov66','John','Doe','shamsmoin@yahoo.com','','','::1',1,'2017-02-27 21:59:44');
...
/*Data for the table `sm_voucher` */

/*Table structure for table `sm_voucher_history` */

DROP TABLE IF EXISTS `sm_voucher_history`;
...
/*Data for the table `sm_voucher_history` */

/*Table structure for table `sm_voucher_theme` */

DROP TABLE IF EXISTS `sm_voucher_theme`;
...
/*Data for the table `sm_voucher_theme` */

insert  into `sm_voucher_theme`(`voucher_theme_id`,`image`) values (8,'catalog/demo/canon_eos_5d_2.jpg'),(7,'catalog/demo/gift-voucher-birthday.jpg'),(6,'catalog/demo/apple_logo.jpg');

/*Table structure for table `sm_voucher_theme_description` */

DROP TABLE IF EXISTS `sm_voucher_theme_description`;
...
/*Data for the table `sm_voucher_theme_description` */

insert  into `sm_voucher_theme_description`(`voucher_theme_id`,`language_id`,`name`) values (6,1,'Christmas'),(7,1,'Birthday'),(8,1,'General');

/*Table structure for table `sm_weight_class` */

DROP TABLE IF EXISTS `sm_weight_class`;
...
/*Data for the table `sm_weight_class` */

insert  into `sm_weight_class`(`weight_class_id`,`value`) values (1,1.00000000),(2,1000.00000000),(5,2.20460000),(6,35.27400000);

/*Table structure for table `sm_weight_class_description` */

DROP TABLE IF EXISTS `sm_weight_class_description`;
...
/*Data for the table `sm_weight_class_description` */

insert  into `sm_weight_class_description`(`weight_class_id`,`language_id`,`title`,`unit`) values (1,1,'Kilogram','kg'),(2,1,'Gram','g'),(5,1,'Pound ','lb'),(6,1,'Ounce','oz');
